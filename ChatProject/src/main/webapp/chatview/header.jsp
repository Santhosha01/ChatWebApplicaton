...
<%@ page import="com.santhosh.chatapp.HeaderAction" %>
<%@ page import="com.santhosh.chatapp.SignUpAction" %>
<%@ page import="com.santhosh.chatapp.LoginAction" %>
  <%@ page import="com.santhosh.chatapp.UserWithResponse"%>
...
<div id="userModal" class="modal">
  <div class="modal-content" style="margin: 3% 81%; width: 18%;height: 50%;">
    ...
    <h2></h2>
       ...
       <hr>
    <div style="height: 40px; margin-top: 35px;">
        <input type="file" name="file" id="file" style="display: none;" hidden>
       ...
       <hr>
        ...
        <a href="http://localhost:8080/ChatProject/"><label class="">logout</label></a>
       </div>
  </div>
</div>
